    ...
    <a-page-header title="标签管理" subtitle="管理文章标签">
      <template #extra>
        <a-space>
          ...
          <a-button type="primary" @click="$router.push('/feedops/tags/add')">
          ...
          <a-table-column title="操作">
            <template #cell="{ record }">
              <a-space>
                ...
                <a-button type="text" @click="$router.push(`/feedops/tags/edit/${record.id}`)">
                  编辑
                </a-button>
      ...
      >
        <template #item="{ item }">
          <a-list-item>
            ...
            <a-space>
              <a-button type="text" size="small" @click="$router.push(`/feedops/tags/edit/${item.id}`)">
                编辑
              </a-button>
